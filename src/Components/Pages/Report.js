...
function Report() {
  ...
  useEffect(() => {
    fetch(`http://3.16.11.52:5000/get_user_data?patient_id=${patientID}`)
...
const formattedcnfdiagnosis = userData && userData.cnfdiagnosis
  ...
  return (
    <>
      <div id="print-content" size="A4">
        ...
        <div className="barcode text-right" style={{marginLeft:'64%'}}>
          <Barcode value={patientID} height={50} width={1} />
          </div>
          </div>
          </div>
          <div className="mt-4" style={{ display: 'flex', justifyContent: 'space-between', borderBottom: '1px solid rgb(211, 215, 215)' }}>
            ...
            <p className="" style={{ marginBottom: '0px' }}><b>Patient ID:</b> {patientID}</p>
    ...
    .</b></p>
            ...
            <p className="ps-4"><b>Breath Sound:</b> Clinical assessment notes the presence of abnormal breath sounds, including  {message}  {message1} {message2} {message3} {message4} {message5}. </p>
